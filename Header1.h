...
//public:
//	Team():Player(10),userName("admin"),passWord("123")
//	{
//		this->teamName = "";
//		string teamCaptain= "";
//		string teamCoach="";
...
//	void TournamentData();
//	string get_month();
//	void Compare(float &R,int &W,int &T,int &TR,int &TW, int& indexR,int &indexW);
//	int get_year();
//	int get_date();
//	void ReadFileMa(ifstream &input);
//	void ReadComparing(ifstream &input);
//	void DisplayeResult();
//};