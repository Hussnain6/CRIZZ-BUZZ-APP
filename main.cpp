...
//		int teams;
//		int choice = 0;
//		cout << "-----------welcome to cricc buzz app------------\n";
...
//				int news;
//				cout << "-------------------------------------------------welcome-----------------------------------------\n";
//				cout<< "here is the news you can enter the date and if the date is correct then you can see the ";
//				cout << "the result of that match press 1 to enter the date\n"
//				    << " and press 2 to watch world records \n";
//				try
//				{
//					if (!(cin >> news))
//					{
...
//				else if (news == 2)
//				{
//					cout << "here are the records of the matches ";
//					Matches* obj = new Matches[readTeams];
//					ifstream  open;
//					open.open("Tournament Recordes.txt");
//					for (int i = 0; i < readTeams; i++)
//					{
//						obj[i].ReadComparing(open);
//					}
//					
//					int Team;
//					float MaxRuns =0 ;
//					int MaxWickets = 0;
//					int indexW=0, indexR=0;
//					int TeamR=0, TeamW=0;
//					for (int i = 0; i <readTeams; i++)
//					{
//						Team = i;
//						obj[i].Compare(MaxRuns, MaxWickets, Team, TeamR, TeamW, indexR, indexW);
//					}
//					cout << "\ndisplaying most runs by a player\n";
//					cout << "Team Name        :  ";
//					obj[TeamR].get_teamName();
//					cout << "\nPlayer name      :  "; 
//					obj[TeamR].get_PlayerName(indexR);
//					cout << endl;
//					cout << "RUNS             :  " << MaxRuns << endl;
//					cout << "displaying the most wickets by a plyer ";
//					cout << "\ndisplaying most runs by a player\n";
//					cout << "Team Name        :  ";
//					obj[TeamW].get_teamName();
//					cout << "\nPlayer name      :  ";
//					obj[TeamW].get_PlayerName(indexW);
//					cout << endl;
//					cout << "WICKETS          :  " << MaxWickets << endl;
//					delete[]obj;
//				}
//			}    
//		}
